...
const Services = () => {
  ...
  return (
    <div id="services" className="w-full flex flex-col items-center py-20 font-poppins">
      <div className="w-[90%] sm:w-[80%] md:w-[70%] flex flex-col">
        ...
        <h1 className="uppercase bg-[linear-gradient(45deg,#FFD700,#FFB700,#FF8C00)] text-transparent bg-clip-text text-[36px] sm:text-[42px] md:text-[48px] font-extrabold mt-5">
          Services we can help you with!
        </h1>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-[90%] sm:w-[70%] mt-10 font-raleway">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-[#10192a] px-8 py-14 rounded-3xl shadow flex text-center items-center justify-center hover:shadow-yellow-600 hover:-translate-y-2 transition-all duration-300"
          >
